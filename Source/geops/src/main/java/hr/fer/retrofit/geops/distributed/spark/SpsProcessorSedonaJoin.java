...
public class SpsProcessorSedonaJoin extends AbstractProcessor {

    public SpsProcessorSedonaJoin(String[] args) {
        super(args);
    }

    public static void main(String[] args) throws Exception {
        final AbstractProcessor processor = new SpsProcessorSedonaJoin(args);
        ...
        if (!processor.cmd.hasOption("skip-processing")) {
            ...
            stream.
                    transformToPair(publicationRDD -> {
                        ...
                        JavaPairRDD<Geometry, List<Geometry>> result = JoinQuery.SpatialJoinQuery(subscriptionSpatialRDD, publicationsSpatialRDD, false, true);
                        return result;
                    }).
