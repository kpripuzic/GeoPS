...
public class HpsProcessorSedonaRangeQuery extends AbstractProcessor {

    public HpsProcessorSedonaRangeQuery(String[] args) {
        super(args);
    }

    public static void main(String[] args) throws Exception {
        final AbstractProcessor processor = new HpsProcessorSedonaRangeQuery(args);
        ...
        if (processor.cmd.hasOption("type-of-grid") || processor.cmd.hasOption("type-of-index")) {
        ...
        subscriptionSpatialRDD.rawSpatialRDD.cache();
        ...
        if (!processor.cmd.hasOption("skip-processing")) {
            ...
            stream.
                    ...
                    mapToPair(publicationGeometry-> {
                        ...
                        JavaRDD<Geometry> candidateSubscriptions = RangeQuery.SpatialRangeQuery(subscriptionSpatialRDD, publicationGeometry, true, false);
