...
public class SpisProcessorSedonaFlatJoin extends AbstractProcessor {

    public SpisProcessorSedonaFlatJoin(String[] args) {
        super(args);
    }

    public static void main(String[] args) throws Exception {
        final AbstractProcessor processor = new SpisProcessorSedonaFlatJoin(args);
        ...
        if (!processor.cmd.hasOption("skip-processing")) {
            ...
            stream.
                    transformToPair(publicationRDD -> {
                        ...
                        JavaPairRDD<Geometry, Geometry> result = JoinQuery.SpatialJoinQueryFlat(subscriptionSpatialRDD, publicationsSpatialRDD, true, true);
                        return result;
                    }).
                    filter(pair -> pair._1.getUserData() != null && pair._2.getUserData() != null).
